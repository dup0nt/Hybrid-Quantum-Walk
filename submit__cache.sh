...
# set name of job
#SBATCH --job-name=Q06S80P40SsCU00MJS80
...
# Run the command
srun -c $SLURM_CPUS_PER_TASK python3 /veracruz/projects/c/cquant/Dirac-Quantum-Walk/QuantumWalk/main.py 6 10 1 2 1 2 10000 aer_simulator_statevector 0 80 CPU single 40 0 1 None
