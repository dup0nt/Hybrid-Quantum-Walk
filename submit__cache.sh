...
# set name of job
#SBATCH --job-name=Q05S32P01DsCU00MJS32SCCN_-1

# set the mem for the whole job
#SBATCH --mem-per-cpu=15976M
...
# Run the command
srun mprof run --output /veracruz/projects/c/cquant/Dirac-Quantum-Walk/Output/Profiler/Data/${SLURM_JOB_ID}.prof python3 /veracruz/projects/c/cquant/Dirac-Quantum-Walk/QuantumWalk/main.py 5 32 1 2 1 2 10000 statevector ${SLURM_JOB_ID} 64 CPU double 1 0 1 None 0
