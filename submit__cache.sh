...
# set name of job
#SBATCH --job-name=Q06S128P02DaCUM
...
# Run the command
srun -c $SLURM_CPUS_PER_TASK python3 /veracruz/projects/c/cquant/Dirac-Quantum-Walk/QuantumWalk/main.py 6 128 1 2 1 2 10000 aer_simulator ${SLURM_JOB_ID} 80 CPU double 2 0 1
