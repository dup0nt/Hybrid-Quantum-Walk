...
# set name of job
#SBATCH --job-name=Q06S100P80DsCU00MJS100
...
# Run the command
srun mprof run python3 /veracruz/projects/c/cquant/Dirac-Quantum-Walk/QuantumWalk/main.py 6 100 1 2 1 2 10000 statevector ${SLURM_JOB_ID} 80 CPU double 80 0 1 None
