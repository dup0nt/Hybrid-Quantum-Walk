...
# set name of job
#SBATCH --job-name=Q05S128P01DsCU00MJS128SCCN_-1
...
# Run the command
srun mprof run --output /veracruz/projects/c/cquant/Dirac-Quantum-Walk/Output/Profiler/Data/${SLURM_JOB_ID}.prof python3 /veracruz/projects/c/cquant/Dirac-Quantum-Walk/QuantumWalk/main.py 5 128 1 2 1 2 10000 statevector ${SLURM_JOB_ID} 80 CPU double 1 0 1 None 0
