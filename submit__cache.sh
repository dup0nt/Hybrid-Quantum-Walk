...
# set name of job
#SBATCH --job-name=Q06S128P80DsCU00MJS128SCCN_-1

# set the mem for the whole job
#SBATCH --mem-per-cpu=21300M
...
# Run the command
srun mprof run --output /veracruz/projects/c/cquant/Dirac-Quantum-Walk/Output/Profiler/Data/${SLURM_JOB_ID}.prof python3 /veracruz/projects/c/cquant/Dirac-Quantum-Walk/QuantumWalk/main.py 6 128 1 2 1 2 10000 statevector ${SLURM_JOB_ID} 80 CPU double 80 0 1 None 0
