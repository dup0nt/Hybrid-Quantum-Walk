...
pathe = './Output/Data/'
file = file_name(num_qubits,num_steps,coin_type,theta,boundary,dist_boundary,shots,job_id)

for i in range(num_steps):
    all_results.append(quantum_walk(i,num_qubits,shots,boundary,dist_boundary,coin_type,theta))
